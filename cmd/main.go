...
import (
	...
	"someapp.cn/configmap-restart/internal/controller"
...
func init() {
	...
	utilruntime.Must(opsappv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a333abf6.someapp.cn",
	...
	if err = (&controller.ConfigrestartReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Configrestart")
		os.Exit(1)
	}
